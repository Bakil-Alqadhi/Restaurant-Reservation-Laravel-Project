                    ...
                    <div class="overflow-hidden w-full shadow sm:rounded-md">
                        <div class="px-4 py-5 w-full sm:p-6 bg-slate-100">
                            <div class="grid grid-cols-6 gap-6">
                                ...
                                <div class="col-span-6   sm:col-span-4">
                                    <label for="image" class="block text-sm font-medium text-gray-700">
                                        image</label>
                                    <div>
                                        <img src="{{ url('/images/categories/' . $category->image) }}" class="w-32 h-32"
                                            alt="imgDB">
                                ...
                                <div class="col-span-6  sm:col-span-4">
                                    ...
                                    <textarea name="description" id="description" rows="3"
                                        class="@error('description') border-red-400 @enderror  mt-1 block w-full rounded-md border-gray-300 shadow-sm  focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">{{ $category->description }}</textarea>
                                    @error('description')
                                        <div class="text-sm text-red-400">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class=" px-2 py-3 mt-4  p-4text-right sm:px-4">
                                <button type="submit"
                                    class="px-4 py-2 rounded-md  bg-indigo-500  text-sm font-medium text-white shadow-sm hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2">UPDATE</button>
                            </div>
                        </div>
                    </div>
                </form>
