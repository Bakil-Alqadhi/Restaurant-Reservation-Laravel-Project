<x-guest-layout>
    ...
    <div class="container max-w-lg px-4 py-32 mx-auto text-left bg-center bg-no-repeat bg-cover md:max-w-none md:text-center"
        style="background-image: url('/images/frontend/alexandru-bogdan-ghita-UeYkqQh4PoI-unsplash.jpg')">
        <h1
       ...
       > -->
                ...
                <div class="w-full md:w-1/2">
                    <div class="w-full h-auto overflow-hidden rounded-md shadow-xl sm:rounded-xl">
                        <img src="{{ url('/images/frontend/welcome.jpg') }}" />
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="py-20 bg-gray-50">
        <div class="container items-center max-w-6xl px-4 px-10 mx-auto sm:px-20 md:px-32 lg:px-16">
            <div class="flex flex-wrap items-center -mx-3">
                ...
                <div class="w-full px-3 mb-12 lg:w-1/2 order-0 lg:order-1 lg:mb-0  shadow-xl sm:rounded-xl">
                    {{-- <div class="w-full lg:w-1/2 px-3 mb-12 overflow-hidden rounded-md shadow-xl sm:rounded-xl"> --}}
                    <img class="mx-auto   rounded-md" src="{{ url('/images/frontend/aboutUs.jpg') }}"
                        alt="feature image">
                </div>
            </div>
        </div>
    ...
    <section class="mt-8 bg-white">
        ...
        <div class="container w-full px-5 py-6 mx-auto">
            <div class="grid lg:grid-cols-4 rounded-lg  gap-y-6">
                @foreach ($specials->menus as $menu)
                    <div class="max-w-xs mx-4 mb-2  shadow-lg">
                        <img class="w-full h-48 rounded-lg" src="{{ url('/images/menus/' . $menu->image) }}"
                            alt="Image" />
                        <div class="px-6 py-4">
                        ...
                        <div class="flex items-center justify-between p-4">
                            <span class="text-xl text-green-600">price
                                {{ $menu->price }}
                            </span>
                        </div>
                    </div>
    ...
    <section class="pt-4 pb-12 bg-gray-800">
        ...
        <div class="grid gap-2 lg:grid-cols-3">
            ...
            <div class="max-w-md p-4 bg-white rounded-lg shadow-lg">
                <div class="flex justify-center -mt-16 md:justify-end">
                    <img class="object-cover w-20 h-20 border-2 border-green-500 rounded-full"
                        src="{{ url('/images/frontend/chief1.jpg') }}">
                </div>
                <div>
                    <h2 class="text-3xl font-semibold text-gray-800">Food</h2>
                    <p class="mt-2 text-gray-600">Lorem ipsum dolor sit amet consectetur adipisicing elit. Quae dolores
            ...
            <div class="max-w-md p-4 bg-white rounded-lg shadow-lg">
                <div class="flex justify-center -mt-16 md:justify-end">
                    <img class="object-cover w-20 h-20 border-2 border-green-500 rounded-full"
                        src="{{ url('/images/frontend/chief2.jpg') }}">
                </div>
                <div>
                    <h2 class="text-3xl font-semibold text-gray-800">Food</h2>
                    <p class="mt-2 text-gray-600">Lorem ipsum dolor sit amet consectetur adipisicing elit. Quae dolores
